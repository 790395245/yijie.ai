...
// 八门原位分布（按洛书顺序）
const BASIC_MEN: Record<string, string> = {
  '1': '休门',
  '8': '生门',
  '3': '伤门',
  '4': '杜门',
...
export interface BaMenResult {
  zhiShiGong: string;         // 值使门转动后的宫位
  zhiShiMen: string;          // 值使门
  baMen: Record<string, string>;  // 八门分布
}
...
export function distributeBaMen(
  ...
  // 3. 计算八门转动
  const baMen: Record<string, string> = {};
  baMen['5'] = ''; // 中宫无门
