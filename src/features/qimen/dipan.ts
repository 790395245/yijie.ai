 ...
 * @returns 地盘干分布
 */
export function getDiPan(type: 'yang' | 'yin', num: number): Record<string, string> {
 ...
 * @returns 基本地盘干分布
 */
export function getBasicDiPan(): Record<string, string> {
 ...
 * @returns 调整后的地盘干分布
 */
export function getFeiGongDiPan(type: 'yang' | 'yin', num: number): Record<string, string> {
