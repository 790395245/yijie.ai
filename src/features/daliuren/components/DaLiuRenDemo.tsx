              ...
              >
                ...
                <div className="text-gray-200 prose prose-invert prose-base max-w-none leading-relaxed">
                  <ReactMarkdown
                    ...
                    components={{
                      h1: ({node, ...props}) => <h1 className="text-2xl font-bold mt-6 mb-4 text-green-300" {...props} />,
                      h2: ({node, ...props}) => <h2 className="text-xl font-bold mt-5 mb-3 text-green-300" {...props} />,
                      h3: ({node, ...props}) => <h3 className="text-lg font-bold mt-4 mb-2 text-green-300" {...props} />,
                      ...
                      blockquote: ({node, ...props}) => <blockquote className="border-l-4 border-green-500 pl-4 italic my-4" {...props} />,
                    }}
                  >
                    {message.content}
                  </ReactMarkdown>
