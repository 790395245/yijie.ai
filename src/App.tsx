        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-950 via-indigo-950 to-gray-950 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 py-8 relative z-10">
            <header className="text-center mb-12 relative">
              ...
              <button
                onClick={handleBack}
                className="absolute left-0 top-0 p-3 text-purple-300/70 hover:text-purple-200 hover:bg-purple-900/30 rounded-lg transition-all flex items-center gap-2 backdrop-blur-sm border border-purple-500/20"
                title="返回"
              >
              ...
              <button
                ...
                className="absolute right-0 top-0 p-3 text-purple-300/70 hover:text-purple-200 hover:bg-purple-900/30 rounded-lg transition-all backdrop-blur-sm border border-purple-500/20"
                title="设置"
              >
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="space-y-6">
                ...
                {/* 周易八卦简介 */}
                <div className="max-w-2xl mx-auto mt-8 p-6 bg-gradient-to-br from-indigo-950/50 to-purple-950/50 backdrop-blur-md rounded-xl border border-purple-500/20 shadow-2xl">
            ...
            <main className="max-w-4xl mx-auto">
              <div className="bg-gradient-to-br from-gray-900/80 to-indigo-950/80 backdrop-blur-xl rounded-2xl p-8 shadow-2xl border border-purple-500/20">
                {selectedType === 'liuyao' && (
                  <LiuYaoDemo
